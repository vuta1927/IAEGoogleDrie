...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiServer.Model.Document", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ApiServer.Model.DocumentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ApiServer.Model.Domain", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ApiServer.Model.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ApiServer.Model.EventType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ApiServer.Model.ServiceAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ApiServer.Model.Document", b =>
                {
                    b.HasOne("ApiServer.Model.DocumentType", "DocumentType")
                        .WithMany("Documents")
                        .HasForeignKey("DocumentTypeId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ApiServer.Model.Domain", "Domain")
                        .WithMany("Documents")
            ...
            modelBuilder.Entity("ApiServer.Model.Event", b =>
                {
                    ...
                    b.HasOne("ApiServer.Model.EventType", "EventType")
                        .WithMany()
